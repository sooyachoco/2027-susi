...
const UNIVERSITY_ADMISSIONS_FALLBACK: Record<string, string> = {
  "u-kku": "https://www.admission.konkuk.ac.kr/",
  "u-uos": "https://admission.uos.ac.kr/",
  "u-snu": "https://admission.snu.ac.kr/undergraduate/early/guide",
  "u-yonsei": "https://admission.yonsei.ac.kr/seoul/admission/html/rolling/guide.asp",
  "u-gachon": "https://admission.gachon.ac.kr/",
  "u-dankook": "https://ipsi.dankook.ac.kr/",
  "u-ajou": "https://www.iajou.ac.kr/",
  "u-inha": "https://admission.inha.ac.kr/",
  "u-incheon": "https://admission.inu.ac.kr/",
};
...
export default function Page() {
  ...
  function resolveNames(admissionId: string) {
    ...
    return { universityName: university?.name ?? "대학", departmentName: department?.name ?? "학과", universityId: university?.id ?? admission?.universityId };
  }
