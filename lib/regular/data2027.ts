...
export const regularAdmissions2027: RegularAdmission[] = [
  ...(["가", "나"] as const).flatMap((group) => [
    {
      ...
      department: "인문계열", majorGroup: "인문·어문", group, scoreMetric: "표준점수", koreanWeight: 35, mathWeight: 30, englishWeight: 10, inquiryWeight: 25, inquirySubjects: 2,
    ...
    },
    {
      ...
      department: "자연계열", majorGroup: "자연·공학", group, scoreMetric: "표준점수", koreanWeight: 25, mathWeight: 40, englishWeight: 10, inquiryWeight: 25, inquirySubjects: 2,
    ...
    },
    {
      ...
      department: "상경계열", majorGroup: "경영·경제", group, scoreMetric: "표준점수", koreanWeight: 35, mathWeight: 35, englishWeight: 10, inquiryWeight: 20, inquirySubjects: 2,
  ...
  ]),
  {
    ...
    department: "한양인터칼리지학부", majorGroup: "전체", group: "다", scoreMetric: "표준점수", koreanWeight: 35, mathWeight: 35, englishWeight: 10, inquiryWeight: 20, inquirySubjects: 2, studentRecordWeight: 10,
    recruitmentCount: 60, note: "수능 90% + 학생부종합평가 10%. 상경계열과 동일한 수능 반영비율", sourceUrl: HANYANG_SOURCE, verifiedAt: "2026-09-14",
  },
];
