...
const rows: Array<[string, string, string, string]> = [
  ["hansei", "free", "자유전공학부", "자유전공"],
  ["hansei", "humanities", "인문사회학부", "인문·사회"],
  ["hansei", "advanced", "첨단융합학부", "컴퓨터·AI"],
  ["hansei", "nursing", "간호학과", "보건·간호"],
  ["hansei", "design", "디자인학부", "디자인"],
  ["hansei", "theology", "신학과", "인문·사회"],
  ["shinhan", "business", "경영대학(자율전공선발)", "경영·경제"],
  ["shinhan", "social", "사회과학대학(자율전공선발)", "인문·사회"],
  ["shinhan", "k-culture", "K-CULTURE 대학(자율전공선발)", "미디어·콘텐츠"],
  ["shinhan", "climate", "기후환경·에너지공학과", "공학"],
  ["shinhan", "baduk", "바둑콘텐츠학과", "미디어·콘텐츠"],
  ["shinhan", "media", "미디어영상학과", "미디어·콘텐츠"],
  ["daejin", "business", "경영학과", "경영·경제"],
  ["daejin", "computer", "컴퓨터공학전공", "컴퓨터·소프트웨어"],
  ["daejin", "software", "휴먼IT융합학부", "컴퓨터·AI"],
  ["daejin", "nursing", "간호학과", "보건·간호"],
  ["daejin", "media", "미디어커뮤니케이션학과", "미디어·콘텐츠"],
  ["hankyong", "ai", "AI반도체융합전공", "컴퓨터·AI"],
  ["hankyong", "software", "소프트웨어&서비스전공", "컴퓨터·소프트웨어"],
  ["hankyong", "mechanical", "기계공학전공", "공학"],
  ["hankyong", "business", "경영학전공", "경영·경제"],
  ["hankyong", "design", "디자인건축융합학부", "디자인"],
  ["hsmu", "nursing", "간호학과", "보건·간호"],
  ["hsmu", "clinical", "임상병리학과", "보건·간호"],
  ["hsmu", "physical", "물리치료학과", "보건·간호"],
  ["hsmu", "radiology", "방사선학과", "보건·간호"],
  ["hsmu", "dental", "치위생학과", "보건·간호"],
  ["hsmu", "taekwondo", "태권도학과", "체육"],
];
...
export const verifiedGyeonggiBatch2Admissions: Admission[] = rows.flatMap(([u, s]) => {
  const d = `${u}-${s}`;
  const base = { universityId: u, departmentId: d, academicYear: 2027, source: source(urls[u], 0.9), isMock: false };
  return [
