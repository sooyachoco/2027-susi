...
const rows: Array<[string,string,string,string]> = [
  ["catholic-sungshin", "성신교정 모집단위", "인문·신학", "catholic-sungshin-overall"],
  ["catholic-seongui", "성의교정 모집단위", "의학·간호", "catholic-seongui-overall"],
  ["skuniv", "2027 수시 전체(모집단위 합계)", "전체", "skuniv-overall"],
  ["hansung", "2027 수시 전체(모집단위 합계)", "전체", "hansung-overall"],
  ["hansung", "크리에이티브인문학부", "인문", "hansung-creative"],
  ["hansung", "미래융합사회과학대학", "사회·경영", "hansung-social"],
  ["hansung", "글로벌패션산업학부", "디자인·패션", "hansung-fashion"],
  ["hansung", "문학문화콘텐츠학과", "인문·콘텐츠", "hansung-content"],
  ["hansung", "IT공과대학", "컴퓨터·공학", "hansung-it"],
  ["hansung", "AI응용학과", "AI·컴퓨터", "hansung-ai"],
  ["hansung", "융합보안학과", "AI·보안", "hansung-security"],
  ["hansung", "AI기계로봇공학과", "AI·공학", "hansung-robot"],
  ["hansung", "미래모빌리티학과", "AI·공학", "hansung-mobility"],
  ["hansung", "상상력인재학부", "자유전공", "hansung-imagination"],
];
export const seoulBatch03_2027Departments: Department[] = rows.map(([u,n,c,id]) => ({ id, universityId: u, name: n, category: c }));
