...
const defs: Array<[string, string, string]> = [
  ["liberal-arts", "문과대학", "인문·사회"], ["korean", "국어국문학과", "인문·사회"], ["english", "영어영문학과", "인문·사회"], ["chinese", "중어중문학과", "인문·사회"], ["philosophy", "철학과", "인문·사회"], ["history", "사학과", "인문·사회"], ["geography", "지리학과", "인문·사회"], ["media", "미디어커뮤니케이션학과", "인문·사회"], ["culture", "문화콘텐츠학과", "인문·사회"], ["liberal-science", "문과대학자유전공학부", "인문·사회"],
...
const rows: Array<[string, number, number, number, number]> = [
  ...
  ["일어교육과",3,19,0,0],["수학교육과",6,6,0,0],["체육교육과",13,0,0,0],["교육공학과",12,0,0,0],["영어교육과",6,10,0,0],
  ["KU자유전공학부",0,183,0,65],
];
