...
const adiga = (url: string): DataSource => ({ type: "adiga", url, academicYear: 2027, confidence: 0.95 });

export const coverageTargets2027: CoverageTarget[] = [
  {
    universityId: "anyang", name: "안양대학교", region: "경기", status: "부분검증", priority: 1,
  ...
  {
    universityId: "sookmyung", name: "숙명여자대학교", region: "서울", status: "부분검증", priority: 1,
  ...
  {
    universityId: "seoultech", name: "서울과학기술대학교", region: "서울", status: "부분검증", priority: 1,
  ...
  {
    universityId: "sejong", name: "세종대학교", region: "서울", status: "부분검증", priority: 1,
  ...
  {
    universityId: "hongik", name: "홍익대학교", region: "서울", status: "부분검증", priority: 2,
  ...
  {
    universityId: "catholic", name: "가톨릭대학교", region: "경기", status: "부분검증", priority: 2,
  ...
  {
    universityId: "sungkyul", name: "성결대학교", region: "경기", status: "부분검증", priority: 1,
  ...
  {
    universityId: "hanshin", name: "한신대학교", region: "경기", status: "부분검증", priority: 1,
  ...
  {
    universityId: "hyupsung", name: "협성대학교", region: "경기", status: "부분검증", priority: 1,
  ...
  {
    universityId: "kangnam", name: "강남대학교", region: "경기", status: "부분검증", priority: 1,
    source: { type: "university", url: "https://admission.kangnam.ac.kr/ipsi/yogang.htm?ctg_cd=susi1", academicYear: 2027, confidence: 0.99 },
    note: "2027 최종 수시 모집요강을 공식 원문으로 재대조했다. 정원내 959명(논술 309·지역균형 185·농어촌 40·국가보훈 19·만학도 26·학교생활우수자1 239·학교생활우수자2 55·실기 86)의 모집단위별 배정을 verified로 편입했다. 논술은 논술80+교과20, 지역균형·농어촌·국가보훈·만학도는 교과100, 학교생활우수자1은 서류100, 학교생활우수자2는 1단계 서류100(3배수) 후 2단계 70+면접30, 실기는 디자인 교과40+실기60·체육 교과20+실기80·음악 실기100으로 확인했다. 정원외 94명은 별도 추천 데이터에서 추가 검증한다.",
  },
  {
    universityId: "yongin", name: "용인대학교", region: "경기", status: "확장대기", priority: 2,
...
export const coverageTargetById = new Map(coverageTargets2027.map((target) => [target.universityId, target]));
