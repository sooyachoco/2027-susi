...
export const verifiedSookmyung2027Admissions: Admission[] = [
  ...
  { id: "sookmyung-ai-region-2027", universityId: "sookmyung", departmentId: "sookmyung-ai", academicYear: 2027, name: "지역균형선발", type: "교과", recruitmentCount: 10, studentRecordWeight: 70, documentWeight: 30, csatMinimum: { enabled: false }, source, isMock: false },
  { id: "sookmyung-cs-region-2027", universityId: "sookmyung", departmentId: "sookmyung-cs", academicYear: 2027, name: "지역균형선발", type: "교과", recruitmentCount: 9, studentRecordWeight: 70, documentWeight: 30, csatMinimum: { enabled: false }, source, isMock: false },
  { id: "sookmyung-data-region-2027", universityId: "sookmyung", departmentId: "sookmyung-data", academicYear: 2027, name: "지역균형선발", type: "교과", recruitmentCount: 5, studentRecordWeight: 70, documentWeight: 30, csatMinimum: { enabled: false }, source, isMock: false },
  { id: "sookmyung-free-region-2027", universityId: "sookmyung", departmentId: "sookmyung-free", academicYear: 2027, name: "지역균형선발", type: "교과", recruitmentCount: 29, studentRecordWeight: 70, documentWeight: 30, csatMinimum: { enabled: false }, source, isMock: false },
  ...
  { id: "sookmyung-business-region-2027", universityId: "sookmyung", departmentId: "sookmyung-business", academicYear: 2027, name: "지역균형선발", type: "교과", recruitmentCount: 30, studentRecordWeight: 70, documentWeight: 30, csatMinimum: { enabled: false }, source, isMock: false },
  ...
  { id: "sookmyung-economics-region-2027", universityId: "sookmyung", departmentId: "sookmyung-economics", academicYear: 2027, name: "지역균형선발", type: "교과", recruitmentCount: 16, studentRecordWeight: 70, documentWeight: 30, csatMinimum: { enabled: false }, source, isMock: false },
