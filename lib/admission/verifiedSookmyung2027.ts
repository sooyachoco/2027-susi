...
/** 2027학년도 공식 공개자료에서 모집단위/전형 관계가 명시적으로 확인된 숙명여자대학교 핵심 데이터. */
...
export const verifiedSookmyung2027Admissions: Admission[] = [
  {
    id: "sookmyung-software-ai-2027",
    universityId: "sookmyung",
    departmentId: "sookmyung-ai",
    academicYear: 2027,
    name: "소프트웨어인재",
    type: "학종",
    recruitmentCount: 14,
  ...
  {
    id: "sookmyung-software-cs-2027",
    universityId: "sookmyung",
    departmentId: "sookmyung-cs",
    academicYear: 2027,
    name: "소프트웨어인재",
    type: "학종",
    recruitmentCount: 12,
  ...
  {
    id: "sookmyung-software-data-2027",
    universityId: "sookmyung",
    departmentId: "sookmyung-data",
    academicYear: 2027,
    name: "소프트웨어인재",
    type: "학종",
    recruitmentCount: 9,
