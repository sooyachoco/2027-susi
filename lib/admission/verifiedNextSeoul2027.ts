...
const specs: UniSpec[] = [
  ...
  { id: "sungshin-2027", name: "성신여자대학교", url: "https://ipsi.sungshin.ac.kr/guide/dataroom.htm?bbsid=dataroom&bltn_seq=36049&ctg_cd=susi&mode=view", departments: [
    "국어국문학과","영어영문학과","독일어문·문화학과","프랑스어문·문화학과","일본어문·문화학과","중국어문·문화학과","사학과","정치외교학과","심리학과","지리학과","경제학과","미디어커뮤니케이션학과","경영학과","교육학과","사회교육과","윤리교육과","한문교육과","유아교육과","법학부","수리통계데이터사이언스학부","AI융합학과","융합AI반도체공학과","컴퓨터공학과","융합보안공학과","서비스디자인공학과","청정신소재공학과","바이오식품공학과","바이오신약의과학부","화학·에너지융합학부","바이오헬스융합학부","사회복지학과","간호학과","의류산업학과","소비자산업학과","뷰티산업학과","동양화과","서양화과","조소과","공예과","디자인과","성악과","기악과","작곡과","문화예술경영학과","미디어영상연기학과","현대실용음악학과","무용예술학과","스포츠과학부","창의융합학부"
  ] },
];
