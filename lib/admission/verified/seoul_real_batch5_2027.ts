...
export const seoulRealBatch5Admissions: Admission[] = [
  ...
  { id: "soongsil-real-hakjong", universityId: "soongsil", departmentId: "soongsil-business-real", academicYear: 2027, name: "SSU미래인재", type: "학종", source: { type: "university", academicYear: 2027 }, isMock: false },
  { id: "soongsil-real-gyogwa", universityId: "soongsil", departmentId: "soongsil-business-real", academicYear: 2027, name: "학생부우수자", type: "교과", studentRecordWeight: 100, source: { type: "university", academicYear: 2027 }, isMock: false },
