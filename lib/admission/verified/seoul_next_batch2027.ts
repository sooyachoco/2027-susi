...
export const seoulNextBatch2027Universities: University[] = [
...
export const seoulNextBatch2027Departments: Department[] = [
  ...
  { id: "korea-business", universityId: "korea", name: "경영학과" },
  { id: "korea-computer", universityId: "korea", name: "컴퓨터학과" },
  { id: "yonsei-business", universityId: "yonsei", name: "경영학과" },
  { id: "yonsei-computer", universityId: "yonsei", name: "컴퓨터과학과" },
];

export const seoulNextBatch2027Admissions: Admission[] = [];
