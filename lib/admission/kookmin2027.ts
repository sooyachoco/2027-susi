...
const src="https://admission.kookmin.ac.kr/onschedule/notice.php?ctype=view&no=1066";
const source={type:"university" as const,academicYear:2027,url:src,confidence:.99};
const admission=(id:string,dept:string,name:string,type:"교과"|"학종"|"논술",extra:Partial<Admission>={}):Admission=>({id:`kookmin-${dept}-${id}-2027`,universityId:"kookmin",departmentId:`kookmin-${dept}`,academicYear:2027,name,type,source,isMock:false,...extra});
...
export const kookmin2027VerifiedTotals={kyogwa:586,frontier:724,essay:205,total:1796};
