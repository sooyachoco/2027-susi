...
// 서울캠퍼스 공식 모집인원 합계: 학교장추천자 307, 학교생활우수자 467, 논술 384.
const schoolRecommendationCounts = [41, 29, 30, 19, 22, 11, 22, 8, 7, 3, 8, 5, 5, 5, 4, 5, 37, 5, 4, 4, 3, 19, 7, 4];
const schoolLifeCounts = [67, 49, 48, 30, 34, 16, 34, 11, 11, 5, 6, 6, 6, 6, 4, 6, 58, 6, 6, 5, 5, 28, 9, 5];
const essayCounts = [53, 38, 39, 25, 29, 14, 29, 9, 9, 4, 5, 5, 5, 5, 4, 5, 48, 6, 4, 4, 4, 24, 8, 4];
