...
export class HybridAdmissionRepository implements AdmissionRepository {
  private getVerifiedAdmissions(): Admission[] {
    return dedupeById([
      ...
      ...seoulRealBatch3Admissions, ...seoulRealBatch4Admissions, ...seoulRealBatch5Admissions,
  ...
  async getUniversities(region?: AdmissionQuery["region"]): Promise<University[]> {
    ...
    const all = dedupeById([
      ...
      ...verifiedCatholic2027Universities, ...verifiedAnyang2027Universities, ...verifiedHanshin2027Universities,
      ...seoulRealBatch3Universities, ...seoulRealBatch4Universities, ...seoulRealBatch5Universities,
    ]);
  ...
  async getDepartments(universityId?: string): Promise<Department[]> {
    ...
    const all = dedupeById([
      ...
      ...verifiedCatholic2027Departments, ...verifiedAnyang2027Departments, ...verifiedHanshin2027Departments,
      ...seoulRealBatch3Departments, ...seoulRealBatch4Departments, ...seoulRealBatch5Departments,
    ]);
...
function isVerifiedUniversity(university: University): boolean {
  return /2027|verified|ajou|inha|incheon|dankook|kau|uos|gachon|kwangwoon|ewha|kookmin|myeongji|soongsil|dongguk|cau|skku|hanyang|sogang|hongik|kyunghee|hufs|sookmyung|sejong|catholic|korea|yonsei|snu|anyang|hanshin/i.test(university.id);
}
