...
import { dongduk2027Admissions, dongduk2027DepartmentsWithAggregate, dongduk2027Universities } from "./dongduk2027";
import { kwangwoon2027Admissions, kwangwoon2027DepartmentsWithAggregate, kwangwoon2027Universities } from "./kwangwoon2027";
...
import { redCentralArts2027Admissions, redCentralArts2027Departments } from "./redCentralArts2027";
import { redCentralHarmony2027Admissions, redCentralHarmony2027Departments } from "./redCentralHarmony2027";
import { redCentralOfficial2027Admissions, redCentralOfficial2027Departments } from "./redCentralOfficial2027";
import { redSecond2027Admissions, redSecond2027Departments, redSecond2027Universities } from "./redSecond2027";
import { anyang2027Admissions, anyang2027DepartmentsWithAggregate, anyang2027Universities } from "./anyang2027";
...
export class HybridAdmissionRepository implements AdmissionRepository {
  private getVerifiedAdmissions(): Admission[] {
    return dedupeByKey([
      ...remainingMetro2027Admissions.filter((a) => !["hansung","hanshin","seoultech","sejong","hongik","myeongji","sungshin","dongduk","kwangwoon","sahmyook","skuniv","gangseo","skhu","duksung","swu","konkuk","dongguk","sangmyung","chugye","knsu","kyonggi-seoul"].includes(a.universityId)),
      ...seoulMid2027Admissions, ...seoulLower2027Admissions, ...seoulSecond2027Admissions, ...chugye2027Admissions, ...gangseo2027Admissions, ...skhu2027Admissions, ...duksung2027Admissions, ...seoulwomen2027Admissions, ...dongduk2027Admissions, ...kwangwoon2027Admissions,
      ...
      ...redTop2027Admissions, ...redTopDepartment2027Admissions, ...redTopYonsei2027Admissions, ...redTopYonsei2027SpecialAdmissions, ...redKorea2027Admissions, ...redKoreaSpecial2027Admissions, ...redCentral2027Admissions, ...redCentralArts2027Admissions, ...redCentralHarmony2027Admissions, ...redCentralOfficial2027Admissions, ...redSecond2027Admissions,
      ...anyang2027Admissions,
  ...
  async getUniversities(region?: AdmissionRegion): Promise<University[]> {
    ...
    const all = dedupeByKey([...universities, ...expanded2027Universities, ...remainingMetro2027Universities, ...seoulMid2027Universities, ...seoulLower2027Universities, ...seoulSecond2027Universities, ...chugye2027Universities, ...gangseo2027Universities, ...skhu2027Universities, ...duksung2027Universities, ...seoulwomen2027Universities, ...dongduk2027Universities, ...kwangwoon2027Universities,
...
function dedupeByKey<T extends { id: string }>(items: T[]): T[] { const map = new Map<string, T>(); for (const item of items) { if (!map.has(item.id)) map.set(item.id, item); } return [...map.values()]; }
