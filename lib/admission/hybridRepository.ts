...
export class HybridAdmissionRepository implements AdmissionRepository {
  private getVerifiedAdmissions(): Admission[] {
    return dedupeByKey([
      ...
      ...konkuk2027Admissions, ...seoulTier2Batch2027Admissions, ...seoulBatch03_2027Admissions, ...seoulSpecial2027Admissions, ...seokyeong2027Admissions,
