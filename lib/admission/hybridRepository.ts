...
export class HybridAdmissionRepository implements AdmissionRepository {
  private getVerifiedAdmissions(): Admission[] {
    return dedupeByKey([
      ...
      ...redTop2027Admissions, ...redTopDepartment2027Admissions, ...redTopYonsei2027Admissions, ...redKorea2027Admissions, ...redCentral2027Admissions, ...redSecond2027Admissions,
