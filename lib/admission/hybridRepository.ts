...
export class HybridAdmissionRepository implements AdmissionRepository {
  private getVerifiedAdmissions(): Admission[] {
    return dedupeByKey([
      ...remainingMetro2027Admissions.filter((a) => !["hansung","hanshin","seoultech","sejong","hongik","myeongji","sungshin","dongduk","sahmyook","skuniv","gangseo","skhu","duksung","swu","konkuk","dongguk","kwangwoon","sangmyung","chugye","knsu","kyonggi-seoul"].includes(a.universityId)),
      ...seoulMid2027Admissions, ...seoulLower2027Admissions, ...seoulSecond2027Admissions, ...chugye2027Admissions, ...gangseo2027Admissions, ...skhu2027Admissions, ...duksung2027Admissions, ...seoulwomen2027Admissions, ...dongduk2027Admissions,
