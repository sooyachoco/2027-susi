...
const source = { type: "university" as const, academicYear: 2027, url: "https://www.knsu.ac.kr/ipsi/rolling/application.do?articleNo=55752", confidence: 0.98 };
...
const methods: Array<[string, Admission["type"], number, number?, boolean?]> = [
  ...
  ["경기입상실적우수자", "기타", 31, 10],
  ["실기우수자", "기타", 35, 30],
  ["교과성적우수자", "교과", 50, 80, true],
  ["국가보훈대상자", "교과", 5, 100, true],
  ["특수교육대상자", "기타", 13, 20, true],
  ["농어촌지역학생", "기타", 20, 30, true],
  ["외국인군(북한이탈주민 포함)", "기타", 2],
];
