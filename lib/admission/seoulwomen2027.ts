...
const departmentsData = [
  ...
  ["english", "영어영문학과", "인문"],
  ["korean", "국어국문학과", "인문"],
  ["psychology", "교육심리학과", "인문·교육"],
  ["child", "아동학과", "인문·교육"],
  ["social", "사회복지학과", "사회"],
  ["journalism", "언론영상학부", "미디어·콘텐츠"],
  ["science", "수학과", "자연과학"],
  ["chemistry", "화학과", "자연과학"],
  ["bio", "생명환경공학과", "자연과학"],
  ["food", "식품영양학과", "자연과학"],
  ["software", "소프트웨어학과", "컴퓨터·소프트웨어"],
  ["datascience", "데이터사이언스학과", "컴퓨터·소프트웨어"],
  ["security", "지능정보보호학부", "컴퓨터·소프트웨어"],
  ["design", "산업디자인학과", "예체능"],
  ["visual", "시각디자인전공", "예체능"],
  ["media-design", "첨단미디어디자인전공", "예체능"],
  ["craft", "공예_컬렉터블디자인전공", "예체능"],
  ["free", "자유전공학부", "자유전공"],
  ["ai", "AI융합학부", "컴퓨터·AI"],
];
...
export const seoulwomen2027Admissions: Admission[] = [
  aggregate("ba-rom-seo-ryu", "바롬인재서류전형", "학종", 183, { documentWeight: 100 }),
  aggregate("ba-rom-myeon-jeop", "바롬인재면접전형", "학종", 202, { documentWeight: 50, interview: true }),
  aggregate("sw-convergence", "SW융합인재전형", "학종", 33, { documentWeight: 100 }),
  aggregate("christian-leader", "기독교지도자전형", "학종", 23, { documentWeight: 100 }),
  aggregate("social-integration", "기회균형_사회통합지원", "학종", 61, { documentWeight: 100 }),
  aggregate("rural", "기회균형_농어촌학생", "학종", 63, { documentWeight: 100 }),
