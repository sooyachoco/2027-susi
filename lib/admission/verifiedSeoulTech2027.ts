...
const departmentSeed = [
  ...
  ["seoultech-future-mobility", "미래자동차공학과", "공학·자동차"],
  ...
  ["seoultech-arch-engineering", "건축공학과", "건축·공학"],
  ...
  ["seoultech-itm", "ITM전공", "공학·산업"],
  ["seoultech-msde", "MSDE학과", "공학·산업"],
  ["seoultech-business", "경영학과", "상경"],
  ["seoultech-global-business", "글로벌테크노경영전공", "상경"],
...
const counts: Record<string, Partial<Record<"추천" | "우수" | "창의" | "논술" | "실기", number>>> = {
  "seoultech-robot": { 추천: 26, 우수: 26 },
  "seoultech-future-mobility": { 추천: 14, 우수: 15 },
  "seoultech-mechanical": { 추천: 38, 우수: 39 },
  "seoultech-safety": { 추천: 17, 우수: 18 },
  "seoultech-materials": { 추천: 20, 우수: 19 },
  "seoultech-civil": { 추천: 30, 우수: 31 },
  "seoultech-arch-engineering": { 추천: 19, 우수: 20 },
  "seoultech-architecture": { 추천: 12, 우수: 13 },
  "seoultech-electrical": { 추천: 27, 우수: 27 },
  "seoultech-electronic": { 추천: 22, 우수: 23 },
  "seoultech-ict": { 추천: 13, 우수: 14 },
  "seoultech-computer": { 추천: 22, 우수: 22 },
  "seoultech-chemical": { 추천: 15, 우수: 17 },
  "seoultech-environment": { 추천: 21, 우수: 20 },
  "seoultech-foodbio": { 추천: 13, 우수: 14 },
  "seoultech-precision": { 추천: 10, 우수: 10 },
  "seoultech-optics": { 추천: 10, 우수: 11 },
  "seoultech-sports": { 추천: 15, 우수: 3, 실기: 3 },
  "seoultech-bio": { 추천: 6, 우수: 12, 창의: 2 },
  "seoultech-quantum": { 추천: 4, 창의: 9 },
  "seoultech-energy": { 추천: 7, 창의: 7 },
  "seoultech-ai": { 추천: 27, 창의: 20 },
  "seoultech-semiconductor": { 추천: 18, 창의: 18 },
  "seoultech-design-industrial": { 추천: 13, 우수: 1, 실기: 7 },
  "seoultech-design-visual": { 추천: 3, 우수: 12, 실기: 3 },
  "seoultech-ceramic": { 실기: 14 },
  "seoultech-metal": { 추천: 3, 실기: 15 },
  "seoultech-arts": { 실기: 19 },
  "seoultech-public-admin": { 추천: 14, 우수: 13 },
  "seoultech-english": { 추천: 9, 우수: 9 },
  "seoultech-literature": { 추천: 18, 우수: 17 },
  "seoultech-industrial": { 추천: 18, 우수: 17 },
  "seoultech-itm": { 추천: 9, 우수: 10 },
  "seoultech-msde": { 추천: 12, 우수: 12 },
  "seoultech-business": { 추천: 13, 우수: 14 },
  "seoultech-global-business": { 추천: 11, 우수: 12 },
...
export const verifiedSeoulTech2027Admissions: Admission[] = verifiedSeoulTech2027Departments.flatMap((department) => {
  ...
  const add = (key: string, name: string, type: Admission["type"], recruitCount: number, extra: Partial<Admission> = {}) => {
    const admission = {
      ...
      academicYear: 2027, name, type, source, isMock: false, ...extra,
    } as Admission;
